      ...
      <setting class='switch'>
        <content>
          ...
          <switch class='option-png2jpg'>
            <label>
              <input type="checkbox" class="switch" name="png2jpg" data-disable="png2jpgForce" value="1" <?php checked(($view->data->png2jpg > 0), true); ?> <?php echo ($this->has_image_library ? '' : 'disabled') ?>>
        ...
        <?php if (false === $this->has_image_library): ?>
      ...
      <setting class='switch'>
        <content>
          <switch class='switch_button option-png2jpgforce suboption' id="png2jpgforce">
            <label>
              <input type="checkbox" class="switch" name="png2jpgForce" value="1" <?php checked(($view->data->png2jpg > 1), true); ?> <?php echo ($this->has_image_library ? '' : 'disabled') ?>>
              <div class="the_switch">&nbsp; </div>
