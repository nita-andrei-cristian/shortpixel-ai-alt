...
-->
    <div class='bulk-wrapper'>
      ...
      <?php //endif; ?>
        ...
        <button type="button" class="button-primary button start" id="start-optimize" data-action="open-panel" data-panel="selection" <?php echo ($this->view->error) ? "disabled" : ''; ?>  >
         ...
         <a class='button button-primary' type="button" href="<?php echo admin_url('options-general.php?page=wp-spaatg-settings&part=help'); ?>" target="_blank">
  ...
  <?php if (! $this->view->error): ?>
     <div class='spaatg-bulk-loader' id="bulk-loading" data-status='loading'>
       <div class='loader'>
